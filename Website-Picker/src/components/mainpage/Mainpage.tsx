...
export default function Mainpage() {
  ...
  const toGithub = () => {
    window.open("https://github.com/moki-3", "_blank");
  };

  const toInsta = () => {
    window.open("https://www.instagram.com/moki.pictures?igsh=MXdtdXF5Z2o3ZGFkNQ%3D%3D&utm_source=qr", "_blank");
  }
  const toThreads = () => {
    window.open("https://www.threads.com/@moki.pictures?igshid=NTc4MTIwNjQ2YQ==", "_blank");
  }

  const toPortfolio = () => {
    navigate("/pageNotFound/mokiNotFound");
  }
  ...
  return (
    <>
      {showTopBox && <div className="topBox">
        <div>Hello, World!</div>
        ...
        <div onClick={() => setShowPopUpInfo(!showPopUpInfo)}>
          <svg
    ...
    <div className="center-info"><p>For transparency: With cookies, I mean localstorage. I am saving data to enhance the user experience.</p></div>
      ...
      <div className="ceneter-all">
        <div className="center-box">
          <div className="single-card github" onClick={toGithub}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <div className="single-card instagram"  onClick={toInsta}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <div className="single-card threads"  onClick={toThreads}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <div className="single-card hachClub" onClick={toHackClub}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <div className="single-card portfolio" onClick={toPortfolio}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
